...
/* Modified: Allow UART_CONSOLE and BOOT_SERIAL_UART on same UART
 * We show console output first, then reinitialize for DFU mode
 * The bootloader will use console for output, then switch to DFU
 */
#if 0
